...
(function () {
  ...
  const PROXY_URL = const PROXY_URL = 'https://jarvis-proxy-2.poojasagar0102.workers.dev/'; // <- fill in after deploying your proxy (see /proxy/README.md)
  const CLIENT_TOKEN = const CLIENT_TOKEN = 'jarvis-rivyan-token';
